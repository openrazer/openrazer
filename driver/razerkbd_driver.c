...
static bool is_blade_laptop(struct usb_device *usb_dev)
{
    ...
    case USB_DEVICE_ID_RAZER_BLADE_STEALTH_LATE_2018:
...
static ssize_t razer_attr_read_device_type(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    case USB_DEVICE_ID_RAZER_BLADE_STEALTH_LATE_2018:
        device_type = "Razer Blade Stealth (Late 2018)\n";
        break;
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLADE_STEALTH_LATE_2018) },
    { 0 }
};
