...
static ssize_t razer_attr_read_device_type(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    case USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_TKL_HYPERSPEED_WIRELESS:
        device_type = "Razer BlackWidow V4 TKL Hyperspeed (Wireless)\n";
        break;
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_TKL_HYPERSPEED_WIRED) },
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BLACKWIDOW_V4_TKL_HYPERSPEED_WIRELESS) },
    { 0 }
};
