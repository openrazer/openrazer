...
static int razer_get_report(struct hid_device *hdev, struct razer_report *request, struct razer_report *response)
{
    ...
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK_CHROMA:
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK:
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK_ALT:
...
static ssize_t razer_attr_read_device_type(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_4_DOCK_CHROMA:
        ...
        break;
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK_CHROMA:
        device_type = "Razer Thunderbolt 5 Dock Chroma";
        break;
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK:
        device_type = "Razer Thunderbolt 5 Dock";
        break;
    case USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK_ALT:
        device_type = "Razer Thunderbolt 5 Dock Audio";
        break;
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK_CHROMA) },
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK) },
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_THUNDERBOLT_5_DOCK_ALT) },
