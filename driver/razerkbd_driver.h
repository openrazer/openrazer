...
/* draw frame */
#define RAZER_BLACKWIDOW_CHROMA_EFFECT_CUSTOM 5
...
/* update profile needs to be called after setting keys to reflect changes */
#define RAZER_BLACKWIDOW_CHROMA_EFFECT_SET_KEYS 9
