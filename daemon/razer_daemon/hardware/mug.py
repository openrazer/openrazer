...
class RazerChromaMugHolder(_RazerDeviceBrightnessSuspend):
    ...
    RAZER_URLS = {
        ...
        "top_img": "https://terrycain.github.io/razer-drivers/img/devices/razer-chroma-mug.png",
        "side_img": None,
        "perspective_img": "https://terrycain.github.io/razer-drivers/img/devices/razer-chroma-mug.png"
    }
