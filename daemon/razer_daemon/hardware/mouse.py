...
class RazerNagaHexV2(__RazerDeviceBrightnessSuspend):
    ...
    HAS_MATRIX = False
    MATRIX_DIMS = [-1, -1]  # 1 Row, 15 Cols
    METHODS = ['get_firmware', 'get_matrix_dims', 'has_matrix', 'get_device_name', 'get_device_type_mouse', 'set_dpi_xy', 'set_poll_rate',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.key_manager = _NagaHexV2KeyManager(self._device_number, self.event_files, self, use_epoll=True, testing=self._testing)
