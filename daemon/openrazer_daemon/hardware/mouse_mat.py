...
class RazerFirefly(__RazerDeviceBrightnessSuspend):
    ...
    HAS_MATRIX = True
    MATRIX_DIMS = [1, 15]
    METHODS = ['get_firmware', 'get_matrix_dims', 'has_matrix', 'get_device_name', 'get_device_type_mousemat', 'get_brightness', 'set_brightness', 'set_wave_effect', 'set_static_effect', 'set_spectrum_effect',
