...
class RazerHuntsmanV3ProTenkeyless(_RazerDeviceBrightnessSuspend):
    """
    Class for the Razer Huntsman V3 Pro Tenkeyless
    """
    EVENT_FILE_REGEX = re.compile(r'.*Razer_Huntsman_V3_Pro_Tenkeyless(-if01)?-event-kbd')
    ...
    DEVICE_IMAGE = "https://medias-p1.phoenix.razer.com/sys-master-phoenix-images-container/hf6/h65/9705254191134/huntsman-v3-pro-tkl-2-500x500.png"
