...
class RazerDeathAdderV4ProWired(__RazerDevice):
    ...
    """
    EVENT_FILE_REGEX = re.compile(r'.*usb-Razer_DeathAdder_V4_Pro_E408D86F2BC99521-if0(1|2)-event-kbd')
...
class RazerDeathAdderV4ProWireless(RazerDeathAdderV4ProWired):
    ...
    """
    EVENT_FILE_REGEX = re.compile(r'.*usb-Razer_DeathAdder_V4_Pro_B555CB79CC03E0FC-if0(1|2)-event-kbd')
