...
KEY_MAPPING = {
    ...
    # Row 5
    'M5': (5,0), 'LEFTCTRL': (5,1), 'SUPER': (5,2), 'LEFTALT': (5,3), 'JP3': (5,4), 'SPACE': (5,7), 'JP4': (5,9), 'JP5': (5,10), 'RIGHTALT': (5,11), 'CTXMENU': (5,13), 'RIGHTCTRL': (5,14), 'LEFTARROW': (5,15), 'DOWNARROW': (5,16), 'RIGHTARROW': (5,17), 'NP0': (5,19), 'NPPERIOD': (5,20)
}
