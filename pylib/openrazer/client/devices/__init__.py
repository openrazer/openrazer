...
class RazerDevice(object):
    ...
    def __init__(self, serial, vid_pid=None, daemon_dbus=None):
        ...
        self._capabilities = {
            ...
            'lighting_fire': self._has_feature('razer.device.lighting.chroma', 'setFire'),
            'lighting_fire_variant': self._has_feature('razer.device.lighting.chroma', 'setFireVariant'),
            'lighting_fire_palette': self._has_feature('razer.device.lighting.chroma', 'setFirePalette'),
