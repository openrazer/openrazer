...
class RazerDevice(object):
    ...
    def current_effect(self) -> str:
        ...
        :rtype: str
        """
        return self._dbus_interfaces['device'].getCurrentEffect()

    def current_effect_colours(self) -> bytearray:
        """
        ...
        :rtype: bytearray
        """
        return bytes(self._dbus_interfaces['device'].getCurrentEffectColors())

    def current_effect_speed(self) -> int:
        """
        ...
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentEffectSpeed()

    def current_wave_dir(self) -> int:
        """
        ...
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentWaveDir()

    def current_logo_effect(self) -> str:
        """
        Get current logo effect

        :return: Effect name
        :rtype: str
        """
        return self._dbus_interfaces['device'].getCurrentLogoEffect()

    def current_logo_effect_colours(self) -> bytearray:
        """
        Get current logo effect colors

        :return: Effect colours
        :rtype: bytearray
        """
        return bytes(self._dbus_interfaces['device'].getCurrentLogoEffectColors())

    def current_logo_effect_speed(self) -> int:
        """
        Get current logo effect speed

        :return: Effect speed
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentLogoEffectSpeed()

    def current_logo_wave_dir(self) -> int:
        """
        Get current logo wave direction

        :return: Wave direction
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentLogoWaveDir()

    def current_scroll_effect(self) -> str:
        """
        Get current scroll effect

        :return: Effect name
        :rtype: str
        """
        return self._dbus_interfaces['device'].getCurrentScrollEffect()

    def current_scroll_effect_colours(self) -> bytearray:
        """
        Get current scroll effect colors

        :return: Effect colours
        :rtype: bytearray
        """
        return bytes(self._dbus_interfaces['device'].getCurrentScrollEffectColors())

    def current_scroll_effect_speed(self) -> int:
        """
        Get current scroll effect speed

        :return: Effect speed
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentScrollEffectSpeed()

    def current_scroll_wave_dir(self) -> int:
        """
        Get current scroll wave direction

        :return: Wave direction
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentScrollWaveDir()

    def current_left_effect(self) -> str:
        """
        Get current left effect

        :return: Effect name
        :rtype: str
        """
        return self._dbus_interfaces['device'].getCurrentLeftEffect()

    def current_left_effect_colours(self) -> bytearray:
        """
        Get current left effect colors

        :return: Effect colours
        :rtype: bytearray
        """
        return bytes(self._dbus_interfaces['device'].getCurrentLeftEffectColors())

    def current_left_effect_speed(self) -> int:
        """
        Get current left effect speed

        :return: Effect speed
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentLeftEffectSpeed()

    def current_left_wave_dir(self) -> int:
        """
        Get current left wave direction

        :return: Wave direction
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentLeftWaveDir()

    def current_right_effect(self) -> str:
        """
        Get current right effect

        :return: Effect name
        :rtype: str
        """
        return self._dbus_interfaces['device'].getCurrentRightEffect()

    def current_right_effect_colours(self) -> bytearray:
        """
        Get current right effect colors

        :return: Effect colours
        :rtype: bytearray
        """
        return bytes(self._dbus_interfaces['device'].getCurrentRightEffectColors())

    def current_right_effect_speed(self) -> int:
        """
        Get current right effect speed

        :return: Effect speed
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentRightEffectSpeed()

    def current_right_wave_dir(self) -> int:
        """
        Get current right wave direction

        :return: Wave direction
        :rtype: int
        """
        return self._dbus_interfaces['device'].getCurrentRightWaveDir()
