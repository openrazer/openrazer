...
def parse_args():
    ...
    parser.add_argument('--effect', required=True, type=int,
                        help="Set whether or not to use static colour or last mouse effect for charging. 0 use mouse effect, 1 use colour")
...
def run():
    ...
    set_charging_effect_filepath = os.path.join(
        mouse_dir, "set_charging_effect")
