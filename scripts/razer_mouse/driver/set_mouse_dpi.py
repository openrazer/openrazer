...
def parse_args():
    ...
    parser.add_argument('--dpi_x', required=True, type=int,
                        help="DPI on the X axis (100, 16000)")
    parser.add_argument(
        '--dpi_y', type=int, help="DPI on the Y axis (if omitted, dpi_x is used), (100, 16000)")
