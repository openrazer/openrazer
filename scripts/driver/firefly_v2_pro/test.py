...
if __name__ == '__main__':
    ...
    for index, driver_path in enumerate(find_devices(0x1532, 0x0C08), start=1):
        found_chroma = True

        print("Razer Firefly V2 Pro {0}\n".format(index))
        ...
        if not args.skip_custom:
            # Custom LEDs all rows - 15 LEDs for V2 Pro instead of 19 for V2
