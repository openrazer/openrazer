...
in_file = open('/home/terry/VCS/razer_drivers/gui/chroma_controller/data/img/blackwidow-chroma-keyboard-layout.new.svg', 'r').read()
...
out_file = open('/home/terry/VCS/razer_drivers/gui/chroma_controller/data/img/blackwidow-chroma-keyboard-layout.new.svg', 'w')
